...
from Places_LT.augmentation import RandAugment, RandomResizedCropAndInterpolation, str_to_interp_mode
...
def get_places(args, root_image='path/to/imagenet/', path_imbalance='path/to/imagenet-lt/'):
    train_txt_path = path_imbalance+'Places_LT_train.txt'
    val_txt_path = path_imbalance+'Places_LT_val.txt'
    test_txt_path = path_imbalance+'Places_LT_test.txt'
